...
describe.skip('Load Integration', () => {
  it('should call API and render data correctly', async () => {
    const mockData = { id: 1, name: 'Test Item' }
    const mockApi = vi.spyOn(global, 'fetch').mockResolvedValueOnce(new Response(JSON.stringify(mockData)))

    render(<Load />)

    //looks for the loading text
